---
title: "Introduction"
description: "WAV Public API let's you turn any idea into production-ready audio with the world's most advanced AI models, through one simple API."
---


<div className="wav-hero">
  <span className="wav-live"><span className="wav-live-dot" /> Live now</span>
  <p className="wav-hero-title">WAV v7 and v7 Pro is here</p>
