...
<audio controls="1" controlslist="nodownload nofullscreen noremoteplayback" src="https://cdn1.wav.com/conversions/2104a105-2572-4412-b6fb-f67b0382582a.mp3">Your browser does not support the audio playback.</audio>

<a href="https://cdn1.wav.com/conversions/2104a105-2572-4412-b6fb-f67b0382582a.wav" target="_blank">Download Audio</a>
...
```bash
curl -X POST "https://api.wav.com/api/public/v1/inpaint" \
...
url = "https://api.wav.com/api/public/v1/inpaint"
