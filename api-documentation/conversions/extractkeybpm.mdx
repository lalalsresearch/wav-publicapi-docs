...
```bash
curl -X POST "https://api.wav.com/api/public/v1/extract_key_bpm" \
...
url = "https://api.wav.com/api/public/v1/extract_key_bpm"
...
```json
{
  ...
  "task_id": "69ec90f0-a00a-48f8-bdb3-8728a635e057", 
  "conversion_id": "8be8c439-dbc9-4ae6-8fe3-3fcb95f5a60a", 
  "audio_path": "https://cdn1.wav.com/files/153ea693-aa7e-42cc-9e35-9a09cc011c4d.mp3",
